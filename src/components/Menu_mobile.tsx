export function MenuMobile(){
    return(
        ...
        className="w-full h-screen lg:hidden">
            <h2 className="text-3xl text-white mt-20  font-bold ml-14">
                Cardápio
                </h2>
            <div className="space-y-5 w-full mt-10 grid justify-center">
                ...
                <h3 className="text-3xl w-4/5 mt-10 mx-auto font-extrabold text-white">
                        Melhores opções do nosso estado
                    </h3>
                    <p className="w-4/5 mt-5 mx-auto text-[#BBB]">
                    ...
                    <div className="space-y-2 w-4/5 flex flex-col items-center mx-auto mt-5">
                        <button className="font-black text-[20px] bg-[#93FF0A] border-2 border-[#93FF0A] px-[50px] py-[15px]">
                            Peça agora!
                        </button>
                        <button className="font-black text-[20px] text-white border-2 border-white  px-[6px] py-[15px]">
